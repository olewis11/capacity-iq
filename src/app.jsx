...
function buildDemoSeed(){
  /* Every tier below has >=2 real children — a tier with exactly one child is
     redundant (the child might as well sit directly under its grandparent), so
     where a branch of the org doesn't actually fan out, we just omit that field
     instead of inventing a pointless wrapper node. */
  const discMeta={
    'Frontend - Web Platform - Growth':{color:'#3B82F6',bg:'#DBEAFE',border:'#93C5FD',abbr:'GRO',bu:'SW',dept:'Frontend',discipline:'Web Platform',subdisc:'Growth'},
    'Frontend - Web Platform - Core':  {color:'#0EA5E9',bg:'#E0F2FE',border:'#7DD3FC',abbr:'COR',bu:'SW',dept:'Frontend',discipline:'Web Platform',subdisc:'Core'},
    'Frontend - Mobile - iOS':         {color:'#6366F1',bg:'#EEF2FF',border:'#A5B4FC',abbr:'iOS',bu:'SW',dept:'Frontend',discipline:'Mobile',subdisc:'iOS'},
    'Frontend - Mobile - Android':     {color:'#8B5CF6',bg:'#EDE9FE',border:'#C4B5FD',abbr:'AND',bu:'SW',dept:'Frontend',discipline:'Mobile',subdisc:'Android'},
    'Platform - Services':            {color:'#F59E0B',bg:'#FEF3C7',border:'#FCD34D',abbr:'SVC',bu:'SW',dept:'Platform'},
    'Platform - Data':                {color:'#F97316',bg:'#FFF7ED',border:'#FED7AA',abbr:'DAT',bu:'SW',dept:'Platform'},
    'Platform - QA':                  {color:'#EC4899',bg:'#FCE7F3',border:'#F9A8D4',abbr:'QA', bu:'SW',dept:'Platform'},
    'Electrical - Battery':           {color:'#10B981',bg:'#D1FAE5',border:'#6EE7B7',abbr:'BAT',bu:'HW',dept:'Electrical'},
    'Electrical - Charging':          {color:'#14B8A6',bg:'#CCFBF1',border:'#5EEAD4',abbr:'CHG',bu:'HW',dept:'Electrical'},
    'Mechanical - Chassis':           {color:'#059669',bg:'#D1FAE5',border:'#6EE7B7',abbr:'CHS',bu:'HW',dept:'Mechanical'},
    'Mechanical - Frame':             {color:'#0D9488',bg:'#CCFBF1',border:'#5EEAD4',abbr:'FRM',bu:'HW',dept:'Mechanical'},
  };
  const tierOrder={
    bus:['SW','HW'],
    depts:['Frontend','Platform','Electrical','Mechanical'],
    disciplines:['Web Platform','Mobile'],
    subdiscs:['Growth','Core','iOS','Android'],
  };
  const engineers=[
    {id:'eng-1', name:'Alex Rivera',     discipline:'Frontend - Web Platform - Growth', title:'Senior Software Engineer'},
    {id:'eng-2', name:'Priya Nair',      discipline:'Frontend - Web Platform - Growth', title:'Software Engineer'},
    {id:'eng-3', name:'Jordan Kim',      discipline:'Frontend - Web Platform - Core',   title:'Staff Software Engineer'},
    {id:'eng-4', name:'Sam Okafor',      discipline:'Frontend - Web Platform - Core',   title:'Software Engineer'},
    {id:'eng-5', name:'Taylor Brooks',   discipline:'Frontend - Mobile - iOS',          title:'Senior Software Engineer'},
    {id:'eng-6', name:'Morgan Chase',    discipline:'Frontend - Mobile - Android',      title:'Software Engineer'},
    {id:'eng-7', name:'Casey Lindgren',  discipline:'Platform - Services',              title:'Senior Software Engineer'},
    {id:'eng-8', name:'Devon Park',      discipline:'Platform - Services',              title:'Software Engineer'},
    {id:'eng-9', name:'Riley Thompson',  discipline:'Platform - Data',                  title:'Data Engineer'},
    {id:'eng-10',name:'Jamie Ferreira',  discipline:'Platform - QA',                    title:'QA Engineer', isContractor:true},
    {id:'eng-11',name:'Avery Santos',    discipline:'Electrical - Battery',             title:'Electrical Engineer'},
    {id:'eng-12',name:'Quinn Delacroix', discipline:'Electrical - Charging',            title:'Senior Electrical Engineer'},
    {id:'eng-13',name:'Harper Osei',     discipline:'Mechanical - Chassis',             title:'Mechanical Engineer'},
    {id:'eng-14',name:'Reese Whitfield', discipline:'Mechanical - Frame',               title:'Senior Mechanical Engineer'},
    {id:'eng-15',name:'Skyler Novak',    discipline:'Frontend - Mobile - iOS',          title:'Software Engineer', isContractor:true},
    {id:'eng-16',name:'Elliot Vance',    discipline:'Platform - Services',              title:'Principal Engineer', inactive:true},
  ];
  const projects=[
    {id:'proj-1',name:'Aurora Platform Rebuild',color:PROJECT_COLORS[0],
      startMonth:addMonths(TODAY,-2),endMonth:addMonths(TODAY,9),
      demand:{'Web Platform':2,'Mobile':1.5,'Platform - Services':1.5,'Platform - Data':1,'Platform - QA':0.5},
    ...
    {id:'proj-2',name:'Falcon Hardware Refresh',color:PROJECT_COLORS[1],
      ...
      demand:{'Electrical - Battery':1,'Electrical - Charging':0.75,'Mechanical - Chassis':1,'Mechanical - Frame':0.5},
    ...
    {id:'proj-4',name:'Internal Tools Cleanup',color:PROJECT_COLORS[3],
      ...
      demand:{'Platform - Services':0.5,'Platform - QA':0.5},
